  ...
  <div id="page-login">
    ...
    <q-form ref="form" class="row q-col-gutter-sm">
      <div class="col col-12">
        <qc-input v-model="username" :label="$t('fields.username')" :rules="validation.userName" @blur="isUsernameValid = true"></qc-input>
      </div>
      <div class="col col-12">
        <qc-input type="password" v-model="password" :label="$t('fields.password')" :rules="validation.password" @blur="isPasswordValid = true"></qc-input>
      </div>
      <div class="col col-5">
      ...
      <div class="col col-5">
        <q-btn class="full-width" color="secondary" :label="$t('actions.createAccount')" to="/register"></q-btn>
      </div>
      <div class="col col-7">
        <q-btn class="full-width" color="positive" :label="$t('actions.login')" @click="login"></q-btn>
      </div>
    </q-form>
  </div>
</template>
